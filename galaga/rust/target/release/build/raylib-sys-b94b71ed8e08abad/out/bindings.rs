...
pub const RLGL_VERSION: &[u8; 4] = b"5.0\0";
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of GuiStyleProp"][::std::mem::size_of::<GuiStyleProp>() - 8usize];
    ["Alignment of GuiStyleProp"][::std::mem::align_of::<GuiStyleProp>() - 4usize];
    ["Offset of field: GuiStyleProp::controlId"]
        [::std::mem::offset_of!(GuiStyleProp, controlId) - 0usize];
    ["Offset of field: GuiStyleProp::propertyId"]
        [::std::mem::offset_of!(GuiStyleProp, propertyId) - 2usize];
    ["Offset of field: GuiStyleProp::propertyValue"]
        [::std::mem::offset_of!(GuiStyleProp, propertyValue) - 4usize];
};
#[repr(i32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum GuiState {
